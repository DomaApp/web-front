...
import { LayoutDashboard, Building2, LogOut, ChevronLeft, Menu, Users, MapPin, Home } from 'lucide-react'
...
export default function DashboardLayout() {
  ...
  const navItems = [
    ...
    { to: '/dashboard/announces', icon: Home, label: t('portal.dashboard.nav.announces') },
